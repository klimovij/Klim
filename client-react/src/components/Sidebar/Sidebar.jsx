  ...
  return (
    <SidebarContainer>
      ...
      <SidebarHeader>
        ...
        <div style={{padding:'18px 0 8px 0',textAlign:'center',fontWeight:700,fontSize:'1.18em',letterSpacing:'0.01em',color:'#fff',display:'flex',flexDirection:'column',alignItems:'center'}}>
          ...
          <span className="neon-issa-plus issa-plus-festive" style={{
            fontSize:'2em',
            color:'#43e97b',
            marginTop:2,marginLeft:-50,
            textShadow:'0 0 12px #43e97b, 0 0 32px #43e97b, 0 0 2px #fff, 0 0 24px #43e97b88'
          }}>
          ...
          <style>{`
            @keyframes neonGlow {
              0% { text-shadow: 0 0 8px #43e97b, 0 0 16px #43e97b, 0 0 2px #fff, 0 0 24px #43e97b88; }
              50% { text-shadow: 0 0 24px #43e97b, 0 0 48px #43e97b, 0 0 8px #fff, 0 0 48px #43e97bcc; }
              100% { text-shadow: 0 0 8px #43e97b, 0 0 16px #43e97b, 0 0 2px #fff, 0 0 24px #43e97b88; }
            }
            .neon-issa-plus {
        ...
        <UserInfo>
          <UserDetails>
            <Avatar
              size="88px"
              style={{position:'relative',overflow:'hidden',background:'#e3eaf2',cursor: state.user?.avatarUrl ? 'zoom-in' : 'pointer', fontSize:28}}
              onMouseEnter={()=>setAvatarHover(true)}
              onMouseLeave={()=>setAvatarHover(false)}
              onClick={()=>{
                if (state.user?.avatarUrl) setShowAvatarModal(true);
                else fileInputRef.current?.click();
              }}
              title={state.user?.avatarUrl ? 'Просмотреть/изменить аватар' : 'Загрузить аватар'}
            >
      ...
      {showAvatarModal && state.user?.avatarUrl && (
        <AvatarModalBg onClick={()=>setShowAvatarModal(false)}>
          ...
          <AvatarModalImg src={state.user.avatarUrl} alt="avatar-large" onClick={e=>e.stopPropagation()} />
        </AvatarModalBg>
      )}
