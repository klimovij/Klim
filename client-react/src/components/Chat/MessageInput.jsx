...
const ScheduleButton = styled.button`
  ...
  transition: all 0.15s cubic-bezier(.4,0,.2,1);
  position: relative;
  border-left: 1px solid rgba(34, 37, 85, 0.1);
